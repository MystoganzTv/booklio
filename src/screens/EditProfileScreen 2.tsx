...
export function EditProfileScreen() {
  ...
  const { updateUserProfile, userProfile, resetApp } = useBooklio();
    ...
    <Screen>
      ...
      <View style={styles.dangerSection}>
        ...
        <Text style={styles.dangerBody}>
          Permanently erases your library, reading sessions, achievements, and profile. This action cannot be undone.
        </Text>
        <Pressable
          ...
          onPress={() =>
            Alert.alert(
              "Delete account?",
              "All your books, sessions, and achievements will be permanently erased. This cannot be undone.",
              [
                { text: "Cancel", style: "cancel" },
                { text: "Delete everything", style: "destructive", onPress: () => resetApp() }
              ]
            )
          }
        >
          <Ionicons name="trash-outline" size={16} color={colors.danger} />
          <Text style={styles.dangerButtonText}>Delete account & erase all data</Text>
        </Pressable>
      </View>
    </Screen>
  );
